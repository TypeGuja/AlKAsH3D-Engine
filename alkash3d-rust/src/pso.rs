...
// В pso.rs, исправленная функция create_simple_pso:

// В pso.rs, замените create_simple_pso на эту версию:
...
pub extern "C" fn create_simple_pso(
    ...
    unsafe {
        ...
        // Простейший вершинный шейдер в байткоде (vs_5_0)
        // Просто передаёт позицию и цвет
        let vs_code: &[u8] = &[
        ...
        // Простейший пиксельный шейдер (ps_5_0)
        // Просто возвращает переданный цвет
        let ps_code: &[u8] = &[
            0x44, 0x58, 0x42, 0x43, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        let pso_desc = D3D12_GRAPHICS_PIPELINE_STATE_DESC {
            ...
            PS: D3D12_SHADER_BYTECODE {
                pShaderBytecode: ps_code.as_ptr() as *mut c_void,
