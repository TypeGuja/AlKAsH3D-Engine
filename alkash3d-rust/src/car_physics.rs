...
impl CarPhysicsState {
    ...
    pub fn step(
        ...
        for (i, local_pos) in wheel_local_positions.iter().enumerate() {
            ...
            let lat_force = (-params.lateral_stiffness * v_lat).clamp(-remaining, remaining);
